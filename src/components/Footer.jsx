  ...
  return (
    <div className="footer-container mt-5 border-top">
      <footer className="footer">
        <div className="footer-top">
          ...
          <div className="social">
            <a className="social-link" href="https://www.instagram.com/trivinsai_">
              <img src={instagramIcon} alt="Instagram" className="social-icon" />
            </a>
            <a className="social-link" href="https://www.linkedin.com/company/trivinsai-techpacktron-solutions-pvt-ltd/">
              <img src={linkedinIcon} alt="LinkedIn" className="social-icon" />
            </a>
            <a className="social-link" href="https://www.facebook.com/profile.php?id=61565733548186&mibextid=ZbWKwL">
              <img src={facebookIcon} alt="FaceBook" className="social-icon" />
            </a>
            <a className="social-link" href="https://x.com/trivinsai">
        ...
        <div className="footer-grid">
          ...
          <div className="footer-grid-heading">Services</div>
            <ul className="footer-links-list">
             ...
             <li><Link to="/web-dev" className="footer-link">Web Development</Link></li>
             <li><Link to="/app-dev" className="footer-link">App Development</Link></li>
      ...
      <div className="footer-copyright">
        ...
        <a className="social-link" href="https://www.linkedin.com/in/sahil-phadke-7775352a9/">
              <img src={linkedinIcon} alt="LinkedIn" className="social-icon" />
            </a>
        </p>   
      </div>
